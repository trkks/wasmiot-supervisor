...
def run_module_function_raw_input(module_name, function_name):
    ...
    try:
        logger.info("Running WebAssembly %r with inputs %r", function_name, input_params)
    ...
    logger.debug("Output result length is %s bytes", output_len)
    ...
    logger.debug("Result interpreted to string is %r", result)
